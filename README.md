# All Restaurants in Greater San Francisco Bay Area (Metro), California, US
...
| Full dataset size | 11,226 records |
| Free sample size | 1,000 records (8.91%) |
| Last export | 2026-04-28T17:53:08.560584+00:00 |
| Download | [Latest release asset](https://github.com/Beamstation-Datasets/all-restaurants-in-greater-san-francisco-bay-area-metro-california-us-sample-277491/releases/download/sample-latest/beamstation_277491_restaurants-us-sanfranciscooaklandfremontca_SAMPLE_DIST.csv) |
...
Search for dataset ID `277491` on BeamStation if you want the exact commercial listing.
